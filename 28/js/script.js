...
function wordList(section, pos) {
  ...
  option.innerHTML = '<option selected disabled value="">Επιλέγουμε λέξη ή φράση και μαθαίνουμε τη σημασία της...</option>';
   ...
   infoText.style.color = "#000";
    ...
    if (!dictionary[id][0][word]) {
        infoText.innerHTML = ``
          ...
          mean_example(dictionary[id][0][word], 'meaning', 'Ερμηνεία');
          mean_example(dictionary[id][0][word], 'example', 'Παράδειγμα χρήσης');
     }
}
